...
% 中文支持设置
\usepackage{xeCJK}
\setCJKmainfont[BoldFont=SimHei,ItalicFont=KaiTi]{SimSun} % 设置中文字体为宋体，粗体使用黑体
...
\newCJKfontfamily\lishu{LiSu} % 设置隶书字体命令
\newCJKfontfamily\yahei{Microsoft YaHei} % 设置微软雅黑字体命令
